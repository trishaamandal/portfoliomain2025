// //import React from 'react';    {age theke akhon comment}
// import './Testimonals.css';
// // import Image3 from '../../assets/avatar-3.svg'   {age theke akhon comment}
// // import Image4 from '../../assets/avatar-4.svg'   {age theke akhon comment}
...
//         {
//             id: 1,
//             // image: Image4,{age theke akhon comment}
...
//         {
//             id: 2,
//             // image: Image3,{age theke akhon comment}
...
const Testimonials = () => {
    ...
    //                     <SwiperSlide className="testimonial__item" key={id}>
    //                         <div className="thumb">
    //                             <img src={image || 'default-image-path.svg'} alt={title} />
    //                         </div>
    //                         <h3 className="testimonial__title">{title}</h3>
    //                         <span className="subtitle">{subtitle}</span>
    //                         <div className="comment">{comment}</div>
