const WorkExperience = [
    {
        ...
        yearsActive: "2024",
        information: [
            "Developed and tested scalable applications using JavaScript and Python",
            "Collaborated with the team to integrate backend APIs with frontend interfaces",
            "Optimized software performance to meet industry standards and enhanced user experience",
        ],
    },
    {
        id: 2,
        ...
        yearsActive: "2024",
        information: [
            "Designed and implemented threat detection strategies in simulated environments",
            "Conducted risk assessments and proposed solutions to mitigate security vulnerabilities",
            "Monitored network traffic and ensured compliance with security standards",
        ],
    },
